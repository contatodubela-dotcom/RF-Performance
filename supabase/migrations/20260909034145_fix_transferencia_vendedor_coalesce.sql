...
-- Corrige o uso inválido de pg_catalog.coalesce na implementação privada.
-- Mantém integralmente autorização, atomicidade, capacidade, histórico e auditoria.

create or replace function private.transfer_salesperson_team_impl(
