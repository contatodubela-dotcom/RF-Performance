-- ============================================================================
-- RF Performance â€” AvaliaÃ§Ãµes â€” HomologaÃ§Ã£o Diretor
-- Corrige contexto de equipes exibido para supervisores na visÃ£o gerencial.
-- Data: 2026-08-13
--
-- Escopo:
--   - NÃƒO altera membros visÃ­veis;
--   - NÃƒO altera RLS;
--   - NÃƒO altera grants de acesso Ã s avaliaÃ§Ãµes;
--   - NÃƒO altera tentativas, notas, respostas ou gabaritos;
--   - mantÃ©m vendedores por public.team_members;
...
begin
  ...
  left join lateral (
    ...
    from (
      ...
      -- Vendedor: contexto pelas equipes em que possui vÃ­nculo ativo.
      select distinct
        t.id as team_id,
        t.name as team_name,
        t.sales_location_id,
...
comment on function public.get_managed_assessment_progress(uuid) is
  'VisÃ£o gerencial segura do progresso das avaliaÃ§Ãµes. Supervisor vÃª somente vendedores das prÃ³prias equipes; diretor/admin veem membros operacionais da organizaÃ§Ã£o. Contexto de equipe usa team_members para vendedores e teams.supervisor_member_id para supervisores. NÃ£o expÃµe respostas, gabaritos ou correÃ§Ã£o por questÃ£o.';
